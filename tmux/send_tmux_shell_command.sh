#!/bin/bash
################################################################################
#                           Send TMUX Shell Command                            #
#                                                                              #
#             This script will export a single function that will              #
#          send and execute a shell command in a specific TMUX window          #
################################################################################
...
################################################################################
#===============================================================================
# This function will send and execute a shell command in a specific TMUX window.
#
...
#
# ARGUMENTS:
#   [1 - name] The TMUX session name
#   [2 - cmd] The command to run in the TMUX session
#
# OUTPUTS:
#   N/A - N/A
#
