...
. "${stack_vars[${#stack_vars[@]}-1]}/run_imaging_read_write.sh"
...
# drive or to read all data bits from a drive or to write data across every bit 
# in a drive and read all data bits from the same drive in parallel.
#
...
#                           32M  - 33554432
#                           64M - 67108864
#   [3 - type] The type of test to run
#   [4 - write_random_pattern] Write a random pattern
#
# OUTPUTS:
#   N/A - N/A
#
