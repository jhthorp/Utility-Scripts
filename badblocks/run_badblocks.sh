...
#                                      or                                      #
#          run a BadBlocks test in operational (Non-Destructive) mode          #
################################################################################
...
#                               SCRIPT INCLUDES                                #
################################################################################
. "${stack_vars[${#stack_vars[@]}-1]}/run_badblocks_operational.sh"
. "${stack_vars[${#stack_vars[@]}-1]}/run_badblocks_destructive.sh"

################################################################################
#                                  FUNCTIONS                                   #
################################################################################
#===============================================================================
# This function will run a BadBlocks test in destructive or 
# operational (Non-Destructive) mode.
#
...
#                           32M  - 33554432
#                           64M - 67108864
#   [3 - destructive] The type of test to run
#
# OUTPUTS:
#   N/A - N/A
#
