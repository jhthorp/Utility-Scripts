...
#          use the SYS or SMART commands to list all available drives          #
################################################################################
...
#                               SCRIPT INCLUDES                                #
################################################################################
. "${stack_vars[${#stack_vars[@]}-1]}/list_all_drives_sysctl.sh"
. "${stack_vars[${#stack_vars[@]}-1]}/list_all_drives_smartctl.sh"

################################################################################
#                                  FUNCTIONS                                   #
################################################################################
#===============================================================================
# This function will use the SYS or SMART commands to list all available drives.
#
...
list_all_drives ()
{
  ...
  if [ "${use_sysctl}" = true ]
  then
      echo $(list_all_drives_sysctl)
  else
      echo $(list_all_drives_smartctl)
  fi
}
