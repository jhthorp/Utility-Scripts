#!/bin/bash
################################################################################
#                    Secure Copy Files From A Remote Server                    #
#                                                                              #
#             This script will export a single function that will              #
#                   securely copy files from a remote server                   #
################################################################################
...
################################################################################
#===============================================================================
# This function will securely copy files from a remote server.
#
...
#   [4 - remotePath] The remote directory path to copy from
#   [5 - localPath] The local directory path to copy to
#
# OUTPUTS:
#   N/A - N/A
#
